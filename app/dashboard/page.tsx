...
export default function DashboardPage() {
  ...
  const overview = [
    ...
    { label: "Changes Required", value: rejectedCount, href: "/dashboard/documents?filter=rejected", color: "bg-amber-50 border-amber-200", icon: "bg-amber-100 text-amber-600", svg: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
